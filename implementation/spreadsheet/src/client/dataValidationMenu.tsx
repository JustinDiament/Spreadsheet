...
function DataValidationMenu({ disp } : DataValidationMenuProps) {
    ...
    const removeRule = useSpreadsheetController((controller : ISpreadSheetState) => controller.removeRule);

    // a constant to allow getAllRules to be called on the spreadsheet using the ISpreadSheetState
    const getAllRules = useSpreadsheetController((controller : ISpreadSheetState) => controller.getAllRules);
    ...
    return (
        <div className="mx-4 flex-wrap sp-panel-interior overflow-y-auto"style={disp ? {display:"flex"} : {display:"none"}}>
            ...
            <div className="sp-panel-int-body w-100">
                <div className="w-100 d-flex flex-wrap justify-content-center">
                    ...
                    <div className={"d-flex flex-wrap w-100 my-2"}>
                        <span className={'w-100'}>Value is</span>
                        <select className="form-select w-100 my-1" aria-label="Default select example"
                    ...
                    <div className={'flex-wrap w-100 my-2'} style={type==="num" ? {display:"flex"} : {display:"none"}}>
                        <span className={'w-100'}>Value is</span>
                        <select className="form-select w-100 my-1" aria-label="Default select example"
                    ...
                    <button className={"btn btn-primary justify-content-center w-100 mt-3"} onClick={() => addRules()}>Add Rule</button>
                </div>
            </div>
        </div>
    ) 
